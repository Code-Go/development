...
function Public_GetOrderOfAttractionVisit(angularScope, http) {    
    ...
    $.ajax({
        ...
        data: JSON.stringify({ TravelModeId: angularScope.TravelModeId, SourceAttractionID: angularScope.SourceAttractionID, DestinationAttractionID: angularScope.DestinationAttractionID, AttractionID: angularScope.AttractionID, StartDate: angularScope.StartDate, StartTime: angularScope.StartTime }),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
